...
Native SwiftUI port of the web app in `../exchanger` (exchanger.in.ua). iOS 18+, Swift 6, default MainActor isolation.
...
- Web logic to mirror: `../exchanger/src/utils/{resolveExchange,currencyMeta,formatCurrency}.ts`, reducer `../exchanger/src/store/reducers/index.ts`.
